...
namespace SentimentAnalyzerModel
{
    public partial class MLModel1
    {
        public const string RetrainFilePath =  @"C:\Users\Admin\source\repos\SentimentAnalyzer\SentimentAnalyzerModel\Data\depression_dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Text",outputColumnName:@"Text")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.057856224F,L2Regularization=0.37423468F,LabelColumnName=@"Label",FeatureColumnName=@"Features"}))      
